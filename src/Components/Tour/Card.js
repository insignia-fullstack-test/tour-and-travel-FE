    ...
    <div className="card">
      ...
      <div className="card__header">
        <div className="card__picture">
          ...
          <img className="card__picure-img" src={props.products.image} alt="tour-img" />
        </div>
      ...
      <div className="card__details">
        <p className="card__text">{props.products.description}</p>
      </div>

      <div className="card__footer">
        <p>
          <span className="card__footer-value">{formatPrice(props.products.price)}</span>
